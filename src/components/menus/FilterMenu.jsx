      ...
      <div className="p-4 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md text-[1.2rem] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-[1.2rem] text-gray-900">No members</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 flex-1">
              <span className="text-[1.2rem] text-gray-900">Select members</span>
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[1.2rem] text-gray-900">Marked as complete</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-[1.2rem] text-gray-900">Not marked as complete</span>
          </div>
        </div>
      </div>
    </div>
